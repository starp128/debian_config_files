...
/*
 * when it is called, is this function run on random cpu
 */
static int k_looper_cpu_notifier(struct notifier_block *self,
...
static int k_looper_init(void)
{
	...
	perf_cpu_notifier(k_looper_cpu_notifier);
